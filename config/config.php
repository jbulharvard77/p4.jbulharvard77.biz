...
# Default DB name for this app
	define('DB_NAME', 'jbulharv_p4_jbulharvard77_biz'); 
...
# For extra security, you might want to set different salts than what the core uses
	define('PASSWORD_SALT', 'i1cRFNZc0unJe(oc&s6)Ipk73DY6IS8UcqzjUa0E');
	define('TOKEN_SALT', 'i1cRFNZc0unJe(oc&s6)Ipk73DY6IS8UcqzjUa0E');